...
\begin{tikzpicture}[line join=round]
  ...
  \newcommand{\imglayer}[1]{
    ...
    \begin{scope}[canvas is yz plane at x=0,rotate=-90,transform shape]
      \node[] (input image) at ($(offset)+(0,0,0)$) {\includegraphics[height=\ss cm]{#1}};
    \end{scope}
  }



  \deflayer{3.0}{0.1}{0}{red!70!white}
  ...
  \deflayer{3.0}{0.1}{2}{green!70!white}
  ...
  \node (text_input) at ($(1-H)!0.5!(1-G)$)[yshift=10] {verrauschtes Bild};
  \node (text_input) at ($(5-H)!0.5!(5-G)$)[yshift=10] {sauberes Bild};
