...
\code{noise\_factor} von 0.5 (vgl. \ref{sec:generierung_verrauschte_bilder}) auf
...
Deshalb sind die ersten Plätze der Rangliste (vgl. Tabelle \ref{tab:rangliste}) nur mit Modellen, welche die
