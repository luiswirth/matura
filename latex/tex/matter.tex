...
Einheitsfunktion:
Diese Funktion nennt man Rectifier. Beziehungsweise einen \keyword{Rectified
  Lienar Unit} (\keyword{ReLU}). Eigentlich der Name des Neurons nicht der Aktivierungsfunktion.
