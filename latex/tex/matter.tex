...
sich eignen.
\para{}
Im folgenden werden die grobe Funktionsweise von Tensorflow untersuchen. Zuerst
...
ist definiert durch seine Stufe, seine Form und den Datentyp seiner Elemente (z.B. float32).

Einen Tensor definiert man folgendermassen (ausserhalb eines tf.Graphs):
