...
\end{equation}
Wir versuchen also Funktionen $\phi$ und $\psi$ zu finden, welche die Differenz
zwischen den urspruenlichen Features $\vec{x}$ und den Rekonstruktionen
$\vec{\hat{x}}$ minimieren.

Anderst ausgedrueckt versuchen wir Funktion $\phi$ und $\psi$ zu finden, welche
die Differenz der urspruenglichen Inputs $\vec{x}$ und den Rekonstruktionen
