...
Ein weiteres Generatives Modell sind sogennante \keyword{Generative Adversial
  Networks} (GANs). Sie sind der annerkante Status Quo, was generative KNNs
anbelangt.
\para{}
...
Hierzu wird der sogennanten \keyword{Gradient} $\vecf{\nabla}$ verwendet,
...
dritte \refbox{eq:RP3} von vier essentiellen Gleichungen ermittelt wurde.
\\
...
Auf diese Weise entsteht die letzte der vier essentiellen Gleichungen \refbox{eq:RP4}.
...
\para{}
Die Parallelisierung auf der CPU wird einerseits durch sogennantes \keyword{SIMD}
...
\keyword{CUDA} geschrieben. CUDA ist ebenfalls von NVIDIA entwickelt worden und
...
Ich erkläre hiermit, dass ich diese Arbeit selbständig durchgeführt und keine
