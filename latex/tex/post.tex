...
mächtigere Problemstellung zu lösen angedacht.
Aufgrund der Reduktion des Anspruches, wurde das eigentliche Potenzial von
TensorFlow und Keras bei weitem nicht ausgeschöpft. Dadurch könnte ein verfälschter
Eindruck von ihrem eigentlichen Potenzial entstehen. Deshalb ist es essentiell zu erkennen, dass TensorFlow und
Keras zu weit mehr im Stande sind.
\para{}
Um noch einige weitere Konzepte des Maschinellen Lernen, welche teilweise für
diese Arbeit intendiert waren, zu beleuchten, folgt nun ein Ausblick über sonstige Aspekte.

\section*{Variational Autoencoder}
\begin{wrapfigure}{L}{2cm}
  \qrcode[height=2cm]{https://www.youtube.com/watch?v=9zKuYvjFFS8}
\end{wrapfigure}
Wie bereits im Vorwort erwähnt, bestand der ursprüngliche Plan dieser Arbeit
...
\para{}
Ein VAE baut das Grundkonzept eines normalen Autoencoders aus. Bei ihm ist das
Encoding (Repräsentation) eine Stochastische Verteilung, welche den Code
enthält.
Dadurch wird bezwegt, dass Codes, welche nahe beiander sind, auch ähnliche
Decodings (Rekonstruktionen) erzeugen. Dadurch wird der Repräsentationraum
kontinuierlich. Der Decoder kann dann als generatives
Modell verwendet werden. Falls ein VAE mit menschlichen Gesichtern
trainiert wurde, können neue zufällige Codes rekonstruiert werden, welche dann
neue noch nie gesehene Gesichter ergeben.
\para{}
Eine verständliche und gute Erklärung bietet der Youtube-Kanal
``Arxiv-Insights'' in seinem Video ``Variational Autoencoder'':
...
dem Trainingsdatensatz ähneln. Der Diskriminator bekommt immer entweder
ein Sample aus dem Trainingsdatensatz oder ein generiertes Sample vorgelegt und
