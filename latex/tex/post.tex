...
\footnote{
  ...
  aufwendige Projekte nötig und erfordert ein fortgeschritteneres Verständnis.
}.
...
ausführt.
Andererseits werden auf der CPU die ganzen Berechnung auf mehreren sogenannten
\keyword{Threads} ausgeführt. Da fast alle heutigen CPUs mehrere Kerne
besitzen, können nicht nur auf einem einzigen, sondern gleich auf mehreren
