...
\para{}
Das Ziel dieser Arbeit ist daher, dem Leser ein umfassendes Grundverstäntniss
...
werden. Dabei handelt es sich um TensorFlow, ein ursprünlich von Google
...
Bildrauschen von Bildern entfernt werden. Eine beispielshafte
...
\begin{center}
  \textbf{Wie funktioniert Maschinelles Lernen und wie entwickelt man mit diesem
    Wissen ein konkretes Modell in TensorFlow und Keras?}
\end{center}
\para{}
...
\begin{enumerate}
  ...
  \item{Kuenstliche Neuronale Netze als Modelle fuer ML}
