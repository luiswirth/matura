...
\newcommand{\ten}[1]{\overline{\mathbf{#1}}}
\newcommand{\set}[1]{\mathbb{#1}}

\newcommand{\trans}[1]{#1^\mathrm{T}}
\newcommand{\deriv}[2]{\frac{\text{d}#1}{\text{d}#2}}
\newcommand{\partderiv}[2]{\frac{\partial #1}{\partial #2}}
\newcommand{\ideriv}[2]{(\text{d}#1)/(\text{d}#2)}
\newcommand{\ipartderiv}[2]{(\partial #1)/(\partial #2)}

% machine learning
\newcommand{\hyperp}{\lambda}
...
\let\oldcite\cite
\renewcommand{\cite}[1]{{\color{}(\oldcite{#1})}}
