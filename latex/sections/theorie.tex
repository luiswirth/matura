...
\item{
    RAUSNEHMEN? Im Allgemeinen ist die grossgeschriebene Variante $J$ eines Indizes
...
\begin{tikzpicture}\label{sec:partielle_ableitungen}
  \node [mybox] (box) {%
...
Konkret wird die Kostenfunktion $C(\vec{y},\vec{\hat{y}}|\phi_0,\ldots,\phi_n)$ (Die $\phi$ sind die Modellparameter) minimieren, indem die Parameter angepasst werden. Dadurch macht das Modell immer bessere Vorhersagen.
...
Das Gradientenverfahren fuer KNN bezeichnet man als \textbf{Backpropagation}.
