...
welche jeweils aus \keyword{Inputs} und erwarteten Outputs.
bestehen. Diese erwarteten Outputs bezeichnet man auch als \keyword{Labels}.
Die Inputs werden in einem Vektor $\vec{x}=\trans{(x_1,x_2,\ldots,x_n)}$ und
...
\para{}
Um die soeben eingefuerten Begriffe zu verdeutlichen, betrachten wir nun ein Beispiel.
Das Ziel ist es vorhersagen ueber den Preis eines occasion Autos zu machen,
anhand der Anzahl gefahrener Kilometer und dem Alters des Autos.
