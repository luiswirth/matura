...
\begin{defbox}{Partielle Ableitungen}
  ...
  Die partielle Ableitung einer Funktion $f(x_1,\cdots,x_n)$ bezueglich der Variable $x_i$ in einem Punkt $\trs{\vec{a}=(a_1,\cdots,a_n)}$ ist analog zur ``normalen'' Ableitung folgendermassen definiert:
  \begin{equation*}
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[>=latex]
    ...
    \tikzstyle{inp} = [fill=red!70!black]
    \tikzstyle{hid} = [fill=blue!70!black]
    \tikzstyle{ou} = [fill=green!70!black]
