...
Motivation:
Bilder sind gross (Beispiel 224x224x3 = 150'528 Features) -> 150 Mio. Gewichte
fuer nur erste Schicht ?!
...
\subsubsection{Exkurs: cross-correlation vs. covolution}
...
\subsubsection{Convolutions fuer 3D-Volumen (RGB Bilder)}
...
\subsubsection{Convolution Schicht}
Schritte:
